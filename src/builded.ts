...
import { BloodModule } from './app/modules/blood/filesystem';
import { GL_ } from './app/modules/buildartprovider';
import { ContextModule } from './app/modules/context';
import { getQueryVariable } from './utils/browser';
...
injector.install(BloodModule('resources/engines/blood/', getQueryVariable('map')))
