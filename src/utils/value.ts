...
export const IntParseValidator: ParseValidator = (str: string) => Number.parseInt(str) != NaN;
export const FloatParseValidator: ParseValidator = (str: string) => Number.parseFloat(str) != NaN;
