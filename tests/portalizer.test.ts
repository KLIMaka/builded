...
test('getPortals', () => {
  ...
  splitWall(board, 1, 100, 50, ART, REFS, BUILD_API.cloneWall);
  ...
  splitWall(board, 8, 25, 35, ART, REFS, BUILD_API.cloneWall);
  splitWall(board, 9, 25, 65, ART, REFS, BUILD_API.cloneWall);
